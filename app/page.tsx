  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[{ title: 'Patent-backed privacy', copy: 'European patent confirmed for wallet-free verification.' }, { title: 'Blockchain x AI', copy: 'Smart contracts + ML to unlock human insight responsibly.' }, { title: 'Impact-first', copy: 'Products designed for real-world trust, not hype.' }].map((item) => (
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[440px]">
                ...
                <div className="relative rounded-3xl bg-white/80 backdrop-blur border border-gray-200 shadow-xl overflow-hidden">
      ...
      <section id="projects" className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-4">Highlighted Work</h2>
          ...
          <div className="space-y-12">
            <div className="bg-white rounded-2xl shadow-lg border border-indigo-100 overflow-hidden ring-1 ring-indigo-50">
              <div className="grid lg:grid-cols-2">
                <div className="p-8 lg:p-10 order-2 lg:order-1 flex flex-col gap-4 justify-center">
                ...
                <div className="relative min-h-[280px] lg:min-h-[360px] bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-800 order-1 lg:order-2">
                  <Image
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[{ title: 'Private by design', copy: 'No mandatory wallet connections. Verification lives off-chain until users opt in.' }, { title: 'Human-centered AI', copy: 'Models that augment decision-making while protecting user intent and data.' }, { title: 'Momentum through design', copy: 'Clear storytelling and high polish to inspire adoption beyond early adopters.' }].map((principle) => (
            ...
            <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 rounded-3xl text-white p-8 shadow-xl">
