            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[460px]">
                ...
                <div className="relative rounded-[28px] bg-white/85 backdrop-blur-xl border border-indigo-100/60 shadow-2xl overflow-hidden">
                  <div className="relative aspect-[4/5] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
                    <div className="absolute inset-5 rounded-3xl bg-gradient-to-b from-blue-500/15 via-indigo-400/12 to-purple-500/14 blur-2xl" />
                    <div className="absolute inset-3 rounded-3xl border border-white/10 shadow-[0_25px_60px_-35px_rgba(0,0,0,0.45)]">
                      <div className="absolute inset-0 bg-gradient-to-t from-black/15 via-transparent to-white/6" />
                      <Image
